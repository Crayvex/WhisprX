...
const Navbar = () => {
    ...
    <section id='Navbar' className='group h-full w-full'>
        <div className='relative w-full h-full'>
            <a href='/app/profile' className='m-2 mt-6 flex items-center gap-2'>
            ...
            <button type="button" className='flex items-center gap-4 absolute left-2 bottom-10 border border-white/65 hover:border-red-600 hover:bg-red-600 px-[10%] py-2 cursor-pointer rounded overflow-hidden'>
                <LogOut />
