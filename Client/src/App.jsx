...
import Settings from './Components/For Settings/Settings'
...
const App = () => {
  ...
  if(isCheckingAuth){
    return(
      <main data-theme={theme} className='h-dvh w-dvw flex justify-center items-center'>
        <Loader />
      </main>
    )
  }
  ...
  return (
    <main data-theme={theme}>
      <Routes>
        ...
        <Route path='/app/*' element={user ? <UserApp /> : <Navigate to={'/signup'} />} />
      </Routes>
    </main>
  )
}
